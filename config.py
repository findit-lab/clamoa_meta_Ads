...
APIFY_COUNT = int(os.getenv("ADINTEL_APIFY_COUNT", "200"))
...
META_SYNC_INTERVAL_MINUTES = int(os.getenv("META_SYNC_INTERVAL_MINUTES", "30"))
...
META_ALERT_MIN_SPEND = float(os.getenv("META_ALERT_MIN_SPEND", "50000"))
...
LONGEVITY_THRESHOLD_DAYS = int(os.getenv("ADINTEL_LONGEVITY_THRESHOLD_DAYS", "14"))
# C4: pHash 해밍거리 ≤ 이 값이면 근접중복으로 간주.
PHASH_HAMMING_THRESHOLD = int(os.getenv("ADINTEL_PHASH_HAMMING_THRESHOLD", "6"))
# C6: 패턴 lift 신뢰도 경고 기준 (코호트 표본수가 이보다 작으면 저신뢰).
MIN_COHORT_SAMPLE = int(os.getenv("ADINTEL_MIN_COHORT_SAMPLE", "5"))
...
WINNER_MIN_DAYS = int(os.getenv("ADINTEL_WINNER_MIN_DAYS", "30"))
WINNER_MIN_VARIANTS = int(os.getenv("ADINTEL_WINNER_MIN_VARIANTS", "3"))
...
DISAPPEAR_GRACE_RUNS = int(os.getenv("ADINTEL_DISAPPEAR_GRACE_RUNS", "2"))
